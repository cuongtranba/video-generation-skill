---
id: c3-30
c3-seal: 827141ef1500bcad207506e0804ab8f39017bb27d023f2f572fcbbb9db8cb624
...
| c3-3004 | ProjectCard — per-project status card |  | active | Display a single project's status, cost, and primary actions (Generate Script, Resolve Material, etc.) derived from the Zustand projection. |
| c3-3005 | TunePanel — style tuning and storyboard approval panel |  | active | Let the user set voice, speed, caption style, and music before voiceover dispatch, and approve the storyboard once all scenes are ready. |
| c3-3006 | SceneStrip — per-scene asset preview |  | active | Render thumbnails and audio previews for each scene's resolved material and voiceover within TunePanel. |
| c3-3007 | StoryboardApproval — approval gate widget |  | active | Block or enable the ApproveStoryboard action based on per-scene readiness flags from the Zustand projection. |
