---
id: ref-manifest-state
c3-seal: 205a688f26bffe08853b227129bdde6bd2561f1c5b2afb4575e1aab99789058f
title: Resumable project state as a saved-after-every-step JSON manifest
type: ref
goal: Project state must survive process exit and let every pipeline step resume from where the last run stopped, without redoing prior steps. Standardizes where the single source of project truth lives and when it is persisted.
---
