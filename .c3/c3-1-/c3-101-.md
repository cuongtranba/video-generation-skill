---
id: c3-101
c3-seal: a0c0a06b800abc408e525cb0cc1fada682b2b6173e493666bf5aa01bb2603692
title: domain — project model & manifest store
type: component
parent: c3-1
goal: Define the project data model and the persistent, resumable store that every other component reads and writes.
uses:
    - ref-manifest-state
    - rule-error-wrap
    - rule-no-any-data
