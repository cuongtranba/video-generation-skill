...
| c3-2007 | caption — Whisper caption transcription and ASS generation |  | active | Transcribe scene voiceovers with whisper and emit a project-level ASS subtitle file for the render. |
...
| c3-2009 | prereq — external binary resolver |  | active | Resolve and verify ffmpeg, ffprobe, and whisper binaries at startup, honoring FFMPEG_BIN/FFPROBE_BIN/WHISPER_BIN env overrides. |
