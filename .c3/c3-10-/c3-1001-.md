---
id: c3-1001
c3-seal: f4a30f6e1ffbcf73683feac5ad49f8cf86acd73230d40db7b7c4729852ed21a6
title: events — frozen event catalogue and foldProject
type: component
parent: c3-10
goal: Define the VidgenEvent union and the foldProject reducer that are the cross-language contract between api, worker, and frontend, and the single source of aggregate state.
uses:
    - rule-no-any-data
---
